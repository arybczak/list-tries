...
tests = concat
   [ $(makeTests Property allTries "prop_size1")
   , $(makeTests Property allTries "prop_size2")
   , $(makeTests Property allTries "prop_member1")
   , $(makeTests Property mapsOnly "prop_lookup1")
   , $(makeTests Property mapsOnly "prop_lookupWithDefault1")
   , $(makeTests Property setsOnly "prop_isSubsetOf1")
   , $(makeTests Property setsOnly "prop_isProperSubsetOf1")
   , $(makeTests Property mapsOnly "prop_isSubmapOf1")
   , $(makeTests Property mapsOnly "prop_isProperSubmapOf1")
   , $(makeTests Property mapsOnly "prop_singleton1")
   , $(makeTests Property mapsOnly "prop_insert1")
   , $(makeTests Property allTries "prop_delete1")
   , $(makeTests Property allTries "prop_union1")
   , $(makeTests Property allTries "prop_union2")
   , $(makeTests Property allTries "prop_union3")
   , $(makeTests Property allTries "prop_difference1")
   , $(makeTests Property allTries "prop_difference2")
   , $(makeTests Property allTries "prop_difference3")
--   , $(makeTests Property allTries "prop_intersection1")
--   , $(makeTests Property allTries "prop_intersection2")
   , $(makeTests Property allTries "prop_splitMaxPredecessor")
   , $(makeTests Property allTries "prop_splitMinSuccessor")
   , $(makeTests Property allTries "prop_minView1")
   , $(makeTests Property allTries "prop_maxView1")
   , $(makeTests Property allTries "prop_findPredecessor1")
   , $(makeTests Property allTries "prop_findSuccessor1")
   , $(makeTests Property allTries "prop_findPredecessor2")
   , $(makeTests Property allTries "prop_findSuccessor2")
   , $(makeTests Property allTries "prop_prefixOps1")
   , $(makeTests Property allTries "prop_prefixOps2")
   ]
